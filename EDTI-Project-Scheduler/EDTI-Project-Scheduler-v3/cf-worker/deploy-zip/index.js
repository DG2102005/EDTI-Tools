...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    return res({ error: 'not found', path, method, rawType, isBuf, eventType: typeof event, isArray: Array.isArray(event), eventKeys: typeof event === 'object' && event ? Object.keys(event).slice(0,20) : [], sample: typeof event === 'object' && event ? (JSON.stringify(event).slice(0,500)) : String(event).slice(0,200) }, 404);
  } catch (e) {
